/*
			   _time = (date) call compile preprocessFileLineNumbers "utils\fn_sun.sqf";
				
				NSA_fnc_sun = compile preprocessFileLineNumbers "utils\fn_sun.sqf";
				_time = (date) call NSA_fnc_sun;
